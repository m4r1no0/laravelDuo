                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center space-x-4">
                                    ...
                                    <input type="text" name="color_hex" id="color_hex" value="{{ old('color', '#3b82f6') }}"
                                           class="block w-32 border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500" placeholder="#3b82f6">
                                </div>
                                <p class="mt-1 text-sm text-gray-500">Selecciona un color para identificar este género visualmente.</p>
                                @error('color')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
